...
console.log('Polaris Components:', { Form, FormLayout, TextField, Button, Card, Stack, Layout });
console.log('Layout.Section:', Layout?.Section); // Using optional chaining
    ...
    <Form onSubmit={handleSubmit}>
      <Layout>
        {stores.map((store, index) => (
          <Layout.Section key={index}> {/* Ensure Layout.Section is defined */}
            <Card sectioned>
              <FormLayout>
                <TextField
                  value={store.url}
